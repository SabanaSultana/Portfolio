        ...
        <div className="project-1 project">
          ...
          <div className="project-description">
            ...
            <p>
              ...
              messaging experience. The interface seamlessly integrates with an
              API to deliver real-time responses and intelligent conversation
              flow. Designed for ease of use, the chatbot supports dynamic
              interactions and ensures smooth communication.
            </p>
        ...
        <div className="project-2 project">
          ...
          <div className="project-description">
            ...
            <p>
              ...
              integrating a responsive user interface with a robust server-side
              application to handle business logic and database interactions.
            </p>
